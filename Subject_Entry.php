...
if(!preg_match("/^[1-8]{1}$/",$semester))
{
$_POST['msg']="Enter Semester Between 1 to 8";
}
else if(ctype_alpha($sub_name)==false)
{
$_POST['msg']="Enter Valid Subject";
}
else if($sub_name=="" || $semester=="")
{
$_POST['msg']="Please Enter All Entry";
}
else
{	
...
if($sql_ins==true)
	$msg="Subject Successfully Inserted";
else
